...
function Formations() {
  ...
  return (
    <div>
      <Title title="Les parcours de formation"
        text="<p>Accédez à mes cours en ligne, comprenant des <strong>vidéos détaillées</strong>, des <strong>exercices pratiques</strong> et un suivi structuré, afin de <strong>progresser à votre rythme</strong>, où que vous soyez et quand vous le souhaitez.</p>
<p>Mes formations sont conçues pour être <strong>accessibles à tous</strong>, que vous soyez débutant ou professionnel souhaitant se perfectionner. Chaque parcours est structuré pour <strong>vous guider étape par étape</strong>, avec des ressources variées et des <strong>exercices pratiques</strong>.</p>

<p>Que vous souhaitiez apprendre à votre rythme ou suivre un cursus plus structuré, vous trouverez ici les outils nécessaires pour développer vos compétences et <strong>atteindre vos objectifs professionnels</strong>.</p>

<p>Que vous souhaitiez explorer un domaine spécifique ou suivre mes cours sur une plateforme de votre choix, selon vos besoins et vos préférences d’apprentissage, plusieurs options s’offrent à vous. Vous pouvez retrouver mes formations sur les plateformes UDEMY ou TUTO, qui offrent une expérience d’apprentissage flexible et adaptée à vos besoins. </p>"
      />
      <SideMediaCard title="Pourquoi choisir mes Cours ?"
